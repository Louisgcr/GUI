var w = window.innerWidth > 960 ? 960 : (window.innerWidth || 960),
    ...
    color = d3.scaleQuantize().domain([10000, 7250]).range(["#dadaeb","#bcbddc","#9e9ac8","#807dba","#6a51a3","#54278f","#3f007d"])
...
var d3_geom_voronoi = d3.voronoi().x(function(d) { return d.x; }).y(function(d) { return d.y; })
